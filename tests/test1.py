...
input_file = '../input/sample_input_1.txt'
...
Processing a departure event at time:  21
Processing a departure event at time:  22
...
Final Statistics:
    ...
    Average amount of time spent waiting: 5.8
"""
